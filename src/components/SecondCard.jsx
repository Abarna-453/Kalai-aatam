...
const SecondCard = () => {
  ...
  const goToPrevCard = () => {
    setCurrentCardIndex(
      (prevIndex) => (prevIndex - 1 + secondCards.length) % secondCards.length
    );
  };
    ...
    <div className="second-card-container">
      <MDBCard className="second-card" alignment="center">
        <MDBCardHeader className="second-card-header">
          ...
          <div className="second-card-arrows">
            ...
            <MDBBtn
              ...
              disabled={currentCardIndex === secondCards.length - 1}
            >
        ...
        <MDBCardBody>
          ...
          <MDBBtn
            onClick={handleGoSomewhere}
            className="second-card-footer-btn"
          >
            Visit
          </MDBBtn>
        </MDBCardBody>
